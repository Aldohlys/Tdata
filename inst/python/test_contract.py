...
### 1. Test getValue with one symbol ===
...
### 2. Test getValue with multiple symbols
getValue(["SAF", "SPY", "ESTX50", "SPX"], close = False)

#### 3. Test getOptValue with one strike
...
#### 4. Test getOptValue with multiple strikes
